...
describe("validateTweet", () => {
  ...
  it.each([
    ...
    ["loose numeric captured_at", { ...sample, captured_at: "1" }],
    ["loose human captured_at", { ...sample, captured_at: "May 21 2026" }],
    ["date-only captured_at", { ...sample, captured_at: "2026-05-21" }],
    ["invalid month", { ...sample, captured_at: "2026-13-21T03:04:35.954Z" }],
    ["bad created_at", { ...sample, created_at: "May 21 2026" }],
